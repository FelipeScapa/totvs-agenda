...
import { LayoutDashboard, Wallet, ArrowRightLeft, FileText, AlertTriangle, Settings, Users } from 'lucide-react';
...
import { FinDevedoresView } from './FinDevedoresView';
  ...
  return (
    <Tabs value={tab} onValueChange={setTab}>
      <TabsList className="flex-wrap h-auto">
        ...
        <TabsTrigger value="devedores" className="gap-1"><Users className="w-4 h-4" /> Devedores</TabsTrigger>
